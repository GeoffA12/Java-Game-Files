...
public class MazeRunner {
	...
	// Check to see if you can move in that direction on the board. If you can move, then move 
	// The user's position and print out the game board. If not, then let them know they can't move 
	// And return to the choice method.
	...
	public static void navigatePit(String direction) {
		...
		if (awol == true) {
			...
			if (userAnswer.startsWith("y")) {
				...
				System.out.println("You won't jump. You will stay in the same spot.");
			}
		}
	}
}
